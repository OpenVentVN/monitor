...
public:
    ...
    Q_INVOKABLE void startStopVent(bool _stt);
    Q_INVOKABLE void readParameter();
    Q_INVOKABLE void writeParameter(unsigned char _mode, int _vt, int _ti, unsigned char _f, unsigned char _peep, unsigned char _pip, unsigned char _ps);



signals:
    void m_update_data_pressure( double _data_y);
